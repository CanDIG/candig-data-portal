...
ARG VITE_AGGREGATE_COUNT_THRESHOLD
ARG VITE_CANDIG_VERSION
...
ENV VITE_AGGREGATE_COUNT_THRESHOLD=${VITE_AGGREGATE_COUNT_THRESHOLD}
ENV VITE_CANDIG_VERSION=${VITE_CANDIG_VERSION}
